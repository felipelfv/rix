# This file was generated by the {rix} R package v0.18.6 on 2026-09-02
# with following call:
# >rix(date = "2026-06-22",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "e310b0d604317f66bd915bc65a8b0a74eb842a53"),
  ...
  pkgs = import (fetchTarball {
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "e310b0d604317f66bd915bc65a8b0a74eb842a53";
        sha256 = "sha256-mrxXg/dMa+kfwf1Mn00/ecYnfPs4i9NTBPodrBh//cw=";
      };
